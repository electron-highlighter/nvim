local ts = require("electron_highlighter.treesitter")
...
function M.invert_color(color)
  local hsluv = require("electron_highlighter.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("electron_highlighter", { clear = true })
